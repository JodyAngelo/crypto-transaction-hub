      ...
      <div className="flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex-1 flex flex-col justify-start items-center">
          ...
          <ServiceCard
            ...
            subtitle="Enjoy competitive rates with no hidden fees — get the most value for every transfer."
          />
          <ServiceCard
            color="bg-[#F84550]"
            title="Fastest Transactions"
            icon={<RiHeart2Fill fontSize={21} className="text-white" />}
            subtitle="Experience instant blockchain transfers — optimized for speed without compromising reliability."
          />
        </div>
      </div>
    </div>
